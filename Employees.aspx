<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Employees.aspx.cs" Inherits="OfficeApp.Employees" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="shadow p-4 mb-4 bg-white">
        <div class="badge badge-primary">Employees</div>
        <div>
            <br />
        </div>     <!--will show the list of Departments-->
        ...
        <table class="table-striped border-success">
            <thead>
                <tr>
                    <th data-field="id">
                        <span class="text-success">Employee Id
                        </span>
                    </th>
                    <th data-field="name">
                        <span class="text-success">Employee Name 
                        </span>
                    </th>
