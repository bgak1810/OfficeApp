<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Departments.aspx.cs" Inherits="OfficeApp.Departments" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="shadow p-4 mb-4 bg-white">
        <div class="badge badge-primary">Departments</div>
        <div>
            <br />
        </div>
        ...
        <table class="table-striped border-success">
            <thead>
                <tr>
                    <th data-field="id">
                        <span class="text-success">Department Id
                        </span>
                    </th>
                    <th data-field="name">
                        <span class="text-success">Department Name 
                        </span>
                    </th>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            document.getElementById('btn').addEventListener('click', addObject);
        });
    </script>

    <!-- Include the file where the JSON data is stored -->
    <script type="text/javascript"
        src="Transactions/script.js">
    </script>
    <script type="text/javascript">
